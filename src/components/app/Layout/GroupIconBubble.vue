<template>
  <div class="relative-position q-px-sm q-pl-md">
    ...
    <q-img class="full-width round" ratio="1" :src="imgURL" @mouseover="isHovered = true" @mouseleave="isHovered = false" @click="selectServer">
...
const ballSize = computed(() => {
  if (props.isSelected) return 'lg'
  if (isHovered.value) return 'md'
